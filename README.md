...
* **Post-Challenge phase (indefinite, from July 13 2025):** After the challenge, we will open an indefinite post-challenge phase, which will serve as a public benchmark. This benchmark will consist of two separate leaderboards that will rank encoding models based on their fMRI predictions for [in-distribution (Friends season 7)](https://www.codabench.org/competitions/9482/) or [out-of-distribution (OOD movies)](https://www.codabench.org/competitions/9483/) multimodal movie stimuli, respectively.
